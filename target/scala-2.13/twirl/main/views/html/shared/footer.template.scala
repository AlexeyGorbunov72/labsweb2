...
Seq[Any](format.raw/*1.1*/("""<footer>
    <p>&copy M33041 Горбунов Алексей, все права не защищены</p>
    <p>Дата публикации: <time pubdate datetime="2001-09-11"></time>11 сентября</p>
</footer>"""))
      }
    }
  }
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/views/shared/footer.scala.html
                  HASH: c9be5f8bb080d3f8d981da49c229df9ef29034cf
                  MATRIX: 819->0
                  LINES: 26->1
                  -- GENERATED --
              */
